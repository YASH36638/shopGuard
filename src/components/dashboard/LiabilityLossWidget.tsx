...
export default function LiabilityLossWidget({ totalLoss = 0 }: { totalLoss?: number }) {
  return (
    <div className="bg-red-50 border border-red-200 p-4 rounded-xl shadow-sm flex justify-between items-center relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <h3 className="text-[10px] font-black text-red-800 uppercase tracking-widest mb-1 flex items-center gap-1">
          ...
          Defusal Loss Accrued
        </h3>
        <p className="text-xs text-red-600 font-medium leading-tight max-w-[150px]">
          Amount permanently deducted from Working Capital due to sub-booked rate sales.
        </p>
      </div>
